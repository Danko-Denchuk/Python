...
estaciones.append(Station(0,0,150,-.5,2.5,-1,10,24.5,1))
...
# for station in range(0, len(estaciones)):
#     for points in range(0, 2*len(estaciones)-1, 4):
#         dots[points].rotate(angle=estaciones[station].direction-pi/2, axis=vec(0,1,0), origin=vec(estaciones[station].x0,estaciones[station].y0, estaciones[station].z0))
#         dots[points+1].rotate(angle=estaciones[station].direction-pi/2, axis=vec(0,1,0), origin=vec(estaciones[station].x0,estaciones[station].y0, estaciones[station].z0))
#         dots[points+2].rotate(angle=estaciones[station].direction-pi/2, axis=vec(0,1,0), origin=vec(estaciones[station].x0,estaciones[station].y0, estaciones[station].z0))
#         dots[points+3].rotate(angle=estaciones[station].direction-pi/2, axis=vec(0,1,0), origin=vec(estaciones[station].x0,estaciones[station].y0, estaciones[station].z0))


# print(str(joints[0].x)+str(joints[1].x)+str(joints[0].z)+str(joints[1].z))
